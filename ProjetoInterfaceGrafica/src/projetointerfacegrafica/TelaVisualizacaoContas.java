 ...
 * @author Guilherme
 */
public class TelaVisualizacaoContas extends javax.swing.JFrame {
    //declarando a lista
     LinkedList<ContaBancaria> listaContaBancaria;
    /**
     * Creates new form TelaVisualizaçaoContas
     */
    public TelaVisualizacaoContas(LinkedList<ContaBancaria> listaContaBancaria) {
        initComponents();
        //atribuindo a lista
    ...
    public void atualizaTabela(){
        ...
        for(int i = 0; i < this.listaContaBancaria.size(); i++){
            ...
            modelo.setValueAt(minhaConta.getClienteTitular().getNome(), i, 0);
            modelo.setValueAt(minhaConta.getClienteTitular().getCpf(), i, 1);
    ...
    public void mostraContaBancaria(){
         ContaBancaria minhaConta =this.listaContaBancaria.get(jTContas.getSelectedRow());
            JOptionPane.showMessageDialog(rootPane, "Nome: "+minhaConta.getClienteTitular().getNome() + ", CPF: "+minhaConta.getClienteTitular().getCpf() + ", Saldo: "+minhaConta.getSaldo());
